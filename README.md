...
A graphical user interface is available in [@Aleyr](https://github.com/Aleyr)'s
[fork](https://github.com/Aleyr/EverDrive-Packs-Lists-Database)
for both the build.py and parse.py scripts. If you are having difficulty with
the command line options, please consider trying the GUI version. 
