...
The EverDrive Packs Lists Project is a research initiave
with the goal of allowing users to build real-hardware
optimized ROM packs based on suggested file/folder 
layouts researched by SmokeMonster.
